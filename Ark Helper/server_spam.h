...
namespace spam {
	...
	private:
		...
		struct SpamCoordsPosSetting {
			utils::Point press_to_start = { 930,860 };
			utils::Point search_server = { 1632,194 };
			utils::Point refresh_server = { 925,936 };
			utils::Point join_to_server = { 1707,940 };
			utils::Point join_to_server_mode = { 351,930 };
			utils::Point first_server = { 892,327 };
			utils::Point create_ppl = { 1647,962 };
			utils::Point back_if_server_not_found = { 175,877 };
			utils::Point back2_if_server_not_found = { 955,961 };
			utils::Point exit_to_main_menu = { 953,628 };
		};
